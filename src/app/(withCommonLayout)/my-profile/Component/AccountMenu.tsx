...
export default function AccountMenu() {
  ...
  const { data:myProfileData, isLoading } = useGetMyProfileQuery(undefined);
  console.log({user})
    ...
    <React.Fragment>
      ...
      >
        <Link href={`/my-profile`}>
          <MenuItem>
            <AccountBoxIcon sx={{ background: "transparent", color: "primary.main" }} />
            My Profile
          </MenuItem>
        </Link>
          <Link href={`/`}>
